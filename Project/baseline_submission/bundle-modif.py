...
scheduler = optim.lr_scheduler.OneCycleLR(optimizer, max_lr=1e-2, total_steps=len(train_loader) * 5)
#################### 6 ####################


#################### 7 [train] ####################
cutmix = v2.CutMix(num_classes=100, alpha=1.2)
mixup = v2.MixUp(num_classes=100, alpha=0.3)
